...
const SocialSection = () => {
    return (
        ...
        >
            ...
            <SocialButton name="Email" link="mailto:hello@markhh.com" />
            <SocialButton
                name="LinkedIn"
                link="https://www.linkedin.com/in/huanghe97/"
            />
            <SocialButton name="GitHub" link="https://github.com/MarkHershey" />
            <SocialButton
                name="Google Scholar"
                link="https://scholar.google.com/citations?user=lv1uAiMAAAAJ&hl=en"
            />
            <SocialButton
                name="ResearchGate"
